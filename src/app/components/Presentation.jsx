...
function Presentation() {
  return (
    <section id="presentation" className="relative w-full flex items-center justify-center py-16 px-10 min-h-screen">

  {/* CONTENEDOR PRINCIPAL */}
  <div className="flex items-center gap-60"> {/* gap-20 en lugar de gap-72 */}
    ...
    <div className="max-w-xl">
      ...
      {/* ICONOS */}
      <div className="flex gap-6 text-gray-600 text-3xl mt-6">
